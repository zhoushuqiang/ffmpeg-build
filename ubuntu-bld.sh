...
length=0
SETUP_PATH=/home/suker/work/study/log/2016/06/24/ffmpegbld/build

bldmodule()
{
	echo "==================================================build module $1 begin"
	cd $1
	./configure --prefix=$SETUP_PATH/$1 && make && make install
	cd ../
...
time  curlgetsrc  https://sourceforge.net/projects/opencore-amr/files/fdk-aac/fdk-aac-0.1.4.tar.gz
time  curlgetsrc  https://www.freedesktop.org/software/fontconfig/release/fontconfig-2.12.0.tar.bz2
time  curlgetsrc  http://download.savannah.gnu.org/releases/freetype/freetype-2.6.tar.bz2
time  curlgetsrc  https://files.dyne.org/frei0r/releases/frei0r-plugins-1.5.0.tar.gz
time  curlgetsrc  https://sourceforge.net/projects/lame/files/lame/3.99/lame-3.99.5.tar.gz
time  curlgetsrc  https://github.com/libass/libass/releases/download/0.13.2/libass-0.13.2.tar.xz
time  curlgetsrc  https://sourceforge.net/projects/soxr/files/soxr-0.1.2-Source.tar.xz
time  curlgetsrc  https://github.com/georgmartius/vid.stab/tarball/release-0.98b/georgmartius-vid.stab-release-0.98b-0-g3b35b4d.tar.gz
time  curlgetsrc  http://downloads.xiph.org/releases/ogg/libogg-1.3.2.tar.xz
time  curlgetsrc  http://downloads.xiph.org/releases/vorbis/libvorbis-1.3.5.tar.xz
time  curlgetsrc  http://downloads.xiph.org/releases/theora/libtheora-1.2.0alpha1.tar.xz
time  curlgetsrc  https://sourceforge.net/projects/opencore-amr/files/opencore-amr/opencore-amr-0.1.3.tar.gz
time  curlgetsrc  http://storage.googleapis.com/downloads.webmproject.org/releases/webm/libvpx-1.5.0.tar.bz2
time  curlgetsrc  https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-0.5.0.tar.gz
time  curlgetsrc  ftp://ftp.videolan.org/pub/x264/snapshots/last_x264.tar.bz2
time  curlgetsrc  https://sourceforge.net/projects/opencore-amr/files/opencore-amr/opencore-amr-0.1.3.tar.gz
time  curlgetsrc  https://sourceforge.net/projects/opencore-amr/files/vo-aacenc/vo-aacenc-0.1.3.tar.gz
time  curlgetsrc  https://sourceforge.net/projects/opencore-amr/files/vo-amrwbenc/vo-amrwbenc-0.1.3.tar.gz
time  curlgetsrc  http://downloads.xiph.org/releases/opus/opus-1.1.2.tar.gz
time  curlgetsrc  http://downloads.xiph.org/releases/speex/speexdsp-1.2rc3.tar.gz
time  curlgetsrc  https://github.com/uclouvain/openjpeg/archive/version.2.1.tar.gz
time  curlgetsrc  https://ffmpeg.zeranoe.com/builds/source/external_libraries/rtmpdump-20151223-git-fa8646d.tar.xz
time  curlgetsrc  http://downloads.xvid.org/downloads/xvidcore-1.3.4.tar.bz2
time  curlgetsrc  https://sourceforge.net/projects/zimg/files/zimg/zimg-5.0.0/zimg-5.0.0.tar.gz
time  curlgetsrc  http://ffmpeg.org/releases/ffmpeg-3.0.2.tar.bz2
time  ##===============================================================================
#===============================================================================
#===============================================================================
#===============================================================================
